...
export const PinContainer = ({
    ...
    return (
        <div
            className={cn("relative group/pin z-50  cursor-pointer w-56 h-56 md:w-60 md:h-72", containerClassName)}
            ...
            <div
                ...
                <div
                    ...
                    className="w-56 h-56 md:w-56 md:h-fit absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl  shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black text-neutral-200 border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden">
